...
// 1. Formatat cod (CTRL K, CTRL D)
// 2. Sters cod zombie (liniile: 216; 287-300; 566-575) + sters spatii inutile
// 3. Pe liniile 50-73 am observat ca aveam copy-paste masiv pe acele validari. Copiasem fara sa modific acele Stringuri :))
// 4. Nu consider o greseala faptul ca am creat regiuni. Pot considera o greseala modul in care am grupat ceea ce este in regiuni.
...
namespace AdmitereFacultate
{
    public partial class FormAdmitereFac : Form
    {
        ...
        private void btAdaugaCandidat_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(telefon) || String.IsNullOrWhiteSpace(telefon))
            {
                isValid = false;
            }
